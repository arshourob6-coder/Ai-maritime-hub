...
export const CommandPaletteModal: React.FC<CommandPaletteModalProps> = ({
  ...
  const commandItems: CommandItem[] = [
    ...
    // Top AI Tools
    { id: 'tool_regulatory_hub', title: 'Global Maritime Regulatory & Classification Intelligence Hub', category: 'AI Tools', view: 'regulatory_hub', icon: <ShieldAlert className="w-4 h-4 text-emerald-400" />, badge: 'IMO + IACS', description: 'SOLAS, MARPOL, STCW, IACS URs, 7 Class Societies, Flag Marine Circulars, and RAG Rule Search' },
